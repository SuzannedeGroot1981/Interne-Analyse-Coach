  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="container mx-auto px-4 py-16">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-gray-800 mb-2">1. Bronnen verzamelen</h3>
                <p className="text-sm text-gray-600">Upload documenten en verzamel evidence</p>
              </div>
              <div className="text-center">
        ...
        {/* Main Action Button - Start nieuwe analyse */}
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 mb-6">
                  Begin een nieuwe systematische analyse van je organisatie volgens het 7S-model van McKinsey.
                </p>
              </div>
